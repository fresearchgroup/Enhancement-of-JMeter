 ...
 *
 */
public class ConstantTimer2 extends AbstractTestElement implements Timer, Serializable, LoopIterationListener {
    ...
    @Override
    public long delay() {
        // d = Integer.parseInt(getPropertyAsString(DELAY));
        if(d==0){
        d = delay;}
        else {
            delay = delay + d;
        ...
        //setProperty(DELAY, Integer.toString(d));
        return delay;
    }
