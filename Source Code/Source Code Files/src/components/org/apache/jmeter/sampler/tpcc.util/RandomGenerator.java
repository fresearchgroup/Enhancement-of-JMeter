package org.apache.jmeter.sampler.tpcc.util;

import java.util.*;

@SuppressWarnings("serial")
/**
 * Generates all the random values i.e. numbers and strings to be used in TPC-C testing
 * @author naman
 *
 */
public class RandomGenerator extends Random {
     ...
     * @param minimum
     * @param maximum
     * @returns a int in the range [minimum, maximum]. 
     */
