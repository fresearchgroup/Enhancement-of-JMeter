...
/**
 * It returns the maximum number of warehouses.
 * @since 2.9
 */
public class Getmaxwh extends AbstractFunction {
	/**
	 * @author surabhi
	 */
    ...
    private static final String KEY = "__getmaxwh"; //$NON-NLS-1$

   
    private Object[] variables;

    public static int globalCounter;//MAXINT = 2,147,483,647
    ...
    public synchronized String execute(SampleResult previousResult, Sampler currentSampler)
        ...
        counterString = String.valueOf(whno);
