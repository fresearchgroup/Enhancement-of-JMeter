...
/**
 * Provides a Random function which returns a random string
 * @since 2.9
 */
public class RandomStr extends AbstractFunction {
	/**
	 * @author surabhi
	 */
    ...
    private static final String KEY = "__randomStr_tpcc"; //$NON-NLS-1$
