...
/**
 * Provides a function which returns a random string to be used as last name while running
 * @since 2.9
 */
public class getNonUniformRandomLastNameForRun extends AbstractFunction {
	/**
	 * @author surabhi
	 */
     ...
     * No-arg constructor.
     */
    public getNonUniformRandomLastNameForRun() {
    }
    ...
    public synchronized String execute(SampleResult previousResult, Sampler currentSampler)
      ...
      String randString;
      randString = getLastName(nonUniformRandom(255, C_LAST_RUN_C, 0, 999, r));
