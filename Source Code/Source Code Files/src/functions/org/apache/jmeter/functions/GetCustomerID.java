...
/**
 * Provides a  function which returns a random string representing customer_id
 * @since 2.9
 */
public class GetCustomerID extends AbstractFunction {
	/**
	 * @author surabhi
	 */
    ...
    private static final String KEY = "__getCustomerID"; //$NON-NLS-1$
    ...
    public synchronized String execute(SampleResult previousResult, Sampler currentSampler)
        ...
        int ran2=nonUniformRandom(1023, C_ID_C, 1, 3000, r);
