...
public class HTTPHC4Impl extends HTTPHCAbstractImpl {
    ...
    private int bandwidthCPS = getBandwidth();    	//Applicable bandwidth for bandwidth throttling
    ...
    private static Iterator itr = IpGeneration.ADDRESSES.iterator(); //List of dynamically generated IP addresses.
...
//         Set up HTTP scheme override if necessary ***** This part has been removed from static block to enable runtime bandwidth throttling
//       if (CPS_HTTP > 0) {
//        	//int testBT4 = 1024;
...
//        }
    ...
    /**
     * Implementing Bandwidth Throttling and Dynamic Bandwidth Throttling
    ...
    protected HTTPHC4Impl(HTTPSamplerBase testElement) {
        super(testElement);
        //Testing if value of bandwidth has been reset.
        if(RESET) {
        	CPS = maxCPS;
        	RESET = false;
    ...
    /**
     * Implementing IP Spoofing - Extracting IP's from the array list  and passing to InetAddress
     * @author shekhar
     */
    if(itr.hasNext()) {
