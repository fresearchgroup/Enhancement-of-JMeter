...
public abstract class HTTPSamplerBase extends AbstractSampler
    ...
    public static final String BANDWIDTH_CPS = "HTTPSampler.bandwidthCPS"; // Bandwidth for the connections during Bandwidth Throttling
   ...
   public void setMD5(boolean truth) {
    ...
    /**
     * Set Bandwidth Value for bandwidth throttling
    ...
    /**
     * Extract bandwidth value for Bandwidth Throttling
     * @author Shekhar Saurav
     * @return int
     */
...
//    	log.info("In the Sampler Base");
    ...
    /**
     * Set value for Maximum Permissible Error for Dynamic Bandwidth Throttling
     * @author Shekhar Saurav
     * @param value
     */
    ...
    /**
     * Extract value for Maximum Permissible Error for Dynamic Bandwidth Throtling
     * @author Shekhar Saurav
     * @return double
     */
    ...
    /**
     * Set minimum applicable bandwidth for Dynamic Bandwidth Throttling
     * @author Shekhar Saurav
     * @param value
     */
    ...
    /**
     * Extract minimum applicable bandwidth  for Dynamic Bandwidth Throttling
     * @author Shekhar Saurav
     * @return int
     */
